...
public class LevelOneVSLevelTwo {
	...
	public static void main(String[] args) {
		...
		if (cout2 > cout1) {
			System.out.println("Le level Two de l'IA bat le level One !");
		} else {
			System.out.println("Le level One de l'IA bat le level Two !");
		}
	}
	...
	public static IALevelOne initIALevelOne(String nomJoueur) {
		...
		IALevelOne IA0 = new IALevelOne(nomJoueur, flotteIA, listAttack, listTouched, listTouch, scoreIA, listAttack2, listNextMissile, tirPrec);
		...
		while (nbreShip<5) {
			...
			if (nbreShip == 0) {
				...
				while (check == false) {
					System.out.println(" ");
					Ship a = initShipIALevelOne(IA0, 1);
		    ...
		    if (nbreShip == 1) {
		        ...
		        while (check == false) {
		        	System.out.println(" ");
					Ship a = initShipIALevelOne(IA0, 2);
		    ...
		    if (nbreShip == 3) {
		        ...
		        while (check == false) {
		        		System.out.println(" ");
					Ship a = initShipIALevelOne(IA0, 3);
					System.out.println(a);
					int b = a.shipSize(a.getStartCoord().getCoord(), a.getEndCoord().getCoord());
					System.out.println(b);
					if (IA0.rentreDansGrille(a) == true) {
		    ...
		    if (nbreShip == 4) {
		        ...
		        while (check == false) {
		        		System.out.println(" ");
					Ship a = initShipIALevelOne(IA0, 4);
					System.out.println(a);
					int b = a.shipSize(a.getStartCoord().getCoord(), a.getEndCoord().getCoord());
					System.out.println(b);
					if (IA0.rentreDansGrille(a) == true) {
	...
	public static Ship initShipIALevelOne(IALevelOne IA0, int size) {
		Random r = new Random();
